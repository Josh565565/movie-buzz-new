...
const SignUp = () => {
  return (
    <div className="flex justify-center items-center mt-4">
      <div className="bg-white pt-10 pl-10 w-[400px] pb-5 mb-5 rounded">
        <Link to="/">
          <p className="text-black">MovieBuzz</p>
        </Link>
        <p className="text-blue-400 text-4xl mt-7">Hello,</p>
        <p className="text-blue-700 text-4xl font-bold">Get Started!</p>
        ...
        <p className="text-center mt-5 text-black pr-10">
          ...
          <span className="text-blue-600 cursor-pointer">Sign In</span> here
          now!
        </p>
      </div>
    </div>
